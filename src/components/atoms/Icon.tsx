 ...
 * Icon color options
 */
export type IconColor = 'current' | 'primary' | 'secondary' | 'success' | 'danger' | 'warning';
...
const iconPaths: Record<IconName, string> = {
  ...
  'mic-off':
    'M19 11h-1.7c0 .74-.16 1.43-.43 2.05l1.23 1.23c.56-.98.9-2.09.9-3.28zm-4.02.17c0-.06.02-.11.02-.17V5c0-1.66-1.34-3-3-3S9 3.34 9 5v.18l5.98 5.98zM4.27 3L3 4.27l6.01 6.01V11c0 1.66 1.33 3 2.99 3 .22 0 .44-.03.65-.08l1.66 1.66c-.98.56-2.09.9-3.28.9-2.76 0-5.3-2.1-5.3-5.1H5c0 3.41 2.72 6.23 6 6.72V21h2v-3.28c.91-.13 1.77-.45 2.54-.9L19.73 21 21 19.73 4.27 3z',
};
...
/**
 * Reusable Icon component that renders SVG icons.
 * Supports multiple icon names, sizes, and colors.
 *
 * @example
 * ```tsx
 * // Basic usage
...
export const Icon = ({
  ...
  // If aria-label is provided, the icon is accessible; otherwise it's decorative
  const accessibilityProps = ariaLabel
    ? { 'aria-label': ariaLabel, role: 'img' }
    : { 'aria-hidden': true as const, role: 'img' };

  // Special handling for spinner icon (uses fill instead of stroke)
  if (isSpinner) {
    return (
      <svg
